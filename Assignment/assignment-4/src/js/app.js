...
function main() {
  ...
  categories.forEach((category) => {
    ...
    button.addEventListener("mouseover", () => {
      button.style.backgroundColor = "#f0f0f0"; // Change background color on hover
      button.style.cursor = "pointer"; // Change cursor to pointer on hover
    });
    button.addEventListener("mouseout", () => {
      button.style.backgroundColor = ""; // Reset background color on mouseout
      button.style.cursor = "default"; // Reset cursor on mouseout
    });
  ...
  // ... The rest of your code for showing the popup container and handling images ...

  // Add the createProductCard function here
  function createProductCard(product) {
    ...
    productImage.addEventListener("mouseover", () => {
      productImage.style.border = "2px solid #f0f0f0"; // Add border on hover
      productImage.style.cursor = "pointer"; // Change cursor to pointer on hover
    });
    productImage.addEventListener("mouseout", () => {
      productImage.style.border = ""; // Remove border on mouseout
      productImage.style.cursor = "default"; // Reset cursor on mouseout
    });
  ...
  // ... The rest of your code for handling images ...
